...
public class AllTestsTest {
	...
	public void testFindClosingCurly() {
		...
		String s = "ab{c,d}ef";
		org.junit.Assert.assertEquals(6, p.findClosingCurlyIdx(s));
	}
	...
	public void testFindClosingCurlyMissing() {
		BashCartesianProducer p = new BashCartesianProducer();
		String s = "ab{c,def";
		org.junit.Assert.assertEquals(-1, p.findClosingCurlyIdx(s));
	}
	...
	public void testFindClosingCurlyLast() {
		BashCartesianProducer p = new BashCartesianProducer();
		String s = "ab{c,d,e,f}";
		org.junit.Assert.assertEquals(10, p.findClosingCurlyIdx(s));
	}
	...
	public void testFindClosingCurlySub() {
		...
		org.junit.Assert.assertEquals(12, p.findClosingCurlyIdx(s));
	}
	...
	public void testFindClosingCurlyLastSub() {
		BashCartesianProducer p = new BashCartesianProducer();
		String s = "ab{c,d{e,f}ghi}";
		org.junit.Assert.assertEquals(14, p.findClosingCurlyIdx(s));
	}
}
